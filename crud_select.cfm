...
<cffunction name="selectCrud" output="false">

<cfargument name="sTableName" type="string" required="true">
<cfargument name="sCommonName" type="string" default="#arguments.sTableName#">
<cfargument name="sCrudName" type="string" default="#arguments.sCommonName##this.selectSuffix#">
...
<cfargument name="bRowLimit" type="boolean" default="true">
<cfargument name="sType" type="string" default="select">
